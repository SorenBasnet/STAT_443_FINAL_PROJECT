...
# What changes with 01_pat_cna.R
...
# Write the patient_file_cna_rai to prediction_death_5_years dataset 
write.table(patient_file_cna_rai, "/Users/sorenbasnet/Documents/Github/STAT_443_FINAL_PROJECT/data/data_patient_file_cna_rai_mutation/patient_cna_rai_mutation.txt", sep=" ", row.names = FALSE, quote = FALSE)
