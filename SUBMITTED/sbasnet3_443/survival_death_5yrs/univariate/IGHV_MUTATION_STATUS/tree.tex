 ...
 % LaTeX file created by GUIDE version 46.2 on 04/25/26 at 13:03
...
\psset{linecolor=black,tnsep=1pt,tndepth=0cm,tnheight=0cm,treesep=2.0cm,levelsep=50pt,radius=10pt,fillstyle=solid}
  \pstree[treemode=D]{\Tcircle{ 1 }~[tnpos=l]{\shortstack[r]{\texttt{\detokenize{IGHV_MUTATION_STATUS}}\\=\texttt{\detokenize{unmutated}}}}
 }{
    \Tcircle[fillcolor=vermillion]{ 2 }~{\shortstack[c]{\emph{472}\\      1.46\\60+}} 
    \Tcircle[fillcolor=vermillion]{ 3 }~{\shortstack[c]{\emph{530}\\      0.63\\60+}} 
 }
 \end{center}
...
for \texttt{\detokenize{surv_5yrs}}.
 ...
 % and pruned from a tree with 3 terminal nodes.
