 ...
 % LaTeX file created by GUIDE version 46.2 on 04/25/26 at 13:48
...
for \texttt{\detokenize{surv_5yrs}}.
 ...
 % and pruned from a tree with 2 terminal nodes.
 % Maximum number of split levels is 15 and minimum node sample size is 2.
 Best split variable is \texttt{\detokenize{X17q_status}}.
 %\end{landscape}
 \end{document}
