...
## Code produced by GUIDE 46.2 on 2/12/26 at 11:12
guide_predict <- function(){
 if(!is.na(heightpc) & heightpc <= 33.9000000000 ){
   ...
   if(!is.na(length2) & length2 <= 26.1500000000 ){
     nodeid <- 6
     predclass <- "parkki"
     posterior <- c( 0.84188E-01, 0.91137E+00, 0.22013E-02, 0.66824E-03, 0.78616E-03, 0.55031E-03, 0.23585E-03)
   } else {
     nodeid <- 7
     predclass <- "bream"
